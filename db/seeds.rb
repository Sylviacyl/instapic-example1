...
susan = User.create(email: 'susan@example.com', password_hash: '657yjt986jio')
bob = User.create(email: 'bob@example.com', password_hash: '23456789')
alice = User.create(email: 'alice@example.com', password_hash: 'Brec234567')
